              ...
              <div class="home-header mb-4" data-aos="fade-down">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <div class="animated-title">
                    <div class="d-flex align-items-center mb-2">
                      ...
                      <div>
                        <h3 class="font-weight-bold mb-0">Kelola Responden</h3>
                        <p class="text-muted mb-0">Manajemen Data Responden DISDUKCAPIL Kota Padang</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-modern card-modern-primary">
                      <div class="card-modern-body">
                        ...
                        <div class="card-modern-content">
                          <h4 class="card-modern-title">Total Responden</h4>
                          <h2 class="card-modern-value"><?= $data['total'] ?? 0 ?></h2>
                          <p class="card-modern-text">Responden terdaftar</p>
                        </div>
                  ...
                  <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card-modern card-modern-success">
                      <div class="card-modern-body">
                        ...
                        <div class="card-modern-content">
                          <h4 class="card-modern-title">Rata-rata Usia</h4>
                          <h2 class="card-modern-value"><?= $data['avg_age'] ?? 0 ?></h2>
                          <p class="card-modern-text">Tahun</p>
                        </div>
                        <div class="card-modern-chart">
                          <div class="progress-chart">
                            <svg viewBox="0 0 100 100">
                  ...
                  <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="card-modern card-modern-info">
                      <div class="card-modern-body">
                        ...
                        <div class="card-modern-content">
                          <h4 class="card-modern-title">Jenis Pekerjaan</h4>
                          <h2 class="card-modern-value"><?= count($data['total_by_pekerjaan'] ?? []) ?></h2>
                          <p class="card-modern-text">Kategori pekerjaan</p>
                        </div>
                        <div class="card-modern-chart">
                          <div class="progress-chart">
                            <svg viewBox="0 0 100 100">
                ...
                <div class="card-modern-search mb-4" data-aos="fade-up" data-aos-delay="300">
                  <div class="card-modern-search-body">
                    <form method="GET" action="index.php?controller=responden&action=index">
                        ...
                        <div class="col-md-10">
                          <div class="search-input-wrapper">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Cari responden berdasarkan nama atau pekerjaan..."
                                   value="<?= htmlspecialchars($data['keyword'] ?? '') ?>">
                            <?php if (!empty($data['keyword'])): ?>
                              <a href="index.php?controller=responden&action=index" class="search-clear">
                            ...
                            <tr class="table-row-modern" data-aos="fade-in" data-aos-delay="<?= $no * 50 ?>">
                              ...
                              <td>
                                <div class="responden-name">
                                  <strong><?= htmlspecialchars($responden['nama_lengkap']) ?></strong>
                                </div>
                              </td>
                              <td>
                                <div class="age-info">
                                  <span class="age-number"><?= $responden['usia'] ?></span>
                              ...
                              <td>
                                <div class="tanggal-info">
                                  ...
                                  <?= date('d/m/Y H:i', strtotime($responden['tanggal_isi'])) ?>
                                </div>
                              </td>
                              <td>
                                <div class="action-buttons-modern">
                                  <a href="index.php?controller=responden&action=detail&id=<?= $responden['id_responden'] ?>"
                                     class="btn-modern-action btn-modern-view"
                                     title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                  </a>
                                  <button onclick="confirmDelete(<?= $responden['id_responden'] ?>)"
                            ...
                            <tr class="empty-state-modern">
                              <td colspan="6" class="text-center">
                                <div class="empty-state-content">
                                  ...
                                  <h4 class="empty-state-title">Belum ada data responden</h4>
                                  <p class="empty-state-text">Data responden akan muncul setelah mengisi form penilaian</p>
                                </div>
                              </td>
                            </tr>
                          <?php endif; ?>
  ...
  <script>
    ...
    function confirmDelete(id) {
      Swal.fire({
        ...
        text: 'Data responden dan semua penilaiannya akan dihapus secara permanen!',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          window.location.href = 'index.php?controller=responden&action=delete&id=' + id;
        }
      });
    }
