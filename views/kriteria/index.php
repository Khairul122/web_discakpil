...
<body class="with-welcome-text">
            ...
            <div class="col-sm-12">
              ...
              <div class="home-header mb-4" data-aos="fade-down">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <div class="animated-title">
                    <div class="d-flex align-items-center mb-2">
                      ...
                      <div>
                        <h3 class="font-weight-bold mb-0">Kelola Kriteria</h3>
                        <p class="text-muted mb-0">Manajemen Data Kriteria Penilaian DISDUKCAPIL Kota Padang</p>
                      </div>
                    </div>
                  </div>
                  <div class="action-buttons">
                    <a href="index.php?controller=kriteria&action=create"
                ...
                <?php if (isset($_SESSION['success'])): ?>
                  <div class="alert alert-modern-success alert-dismissible fade show" role="alert" data-aos="slide-down">
                    <div class="alert-content">
                      <div class="alert-icon">
                  ...
                  <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="card-modern card-modern-success">
                      <div class="card-modern-body">
                        ...
                        <div class="card-modern-content">
                          <h4 class="card-modern-title">Benefit</h4>
                          <h2 class="card-modern-value"><?= $data['benefit_count'] ?? 0 ?></h2>
                          <p class="card-modern-text">Kriteria benefit</p>
                        </div>
                        <div class="card-modern-chart">
                          <div class="progress-chart">
                            <svg viewBox="0 0 100 100">
                  ...
                  <div class="col-md-3" data-aos="fade-up" data-aos-delay="300">
                    <div class="card-modern card-modern-info">
                      <div class="card-modern-body">
                        ...
                        <div class="card-modern-content">
                          <h4 class="card-modern-title">Cost</h4>
                          <h2 class="card-modern-value"><?= $data['cost_count'] ?? 0 ?></h2>
                          <p class="card-modern-text">Kriteria cost</p>
                        </div>
                        <div class="card-modern-chart">
                          <div class="progress-chart">
                            <svg viewBox="0 0 100 100">
                  ...
                  <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                    <div class="card-modern card-modern-warning">
                      <div class="card-modern-body">
                        ...
                        <div class="card-modern-content">
                          <h4 class="card-modern-title">Total Bobot</h4>
                          <h2 class="card-modern-value"><?= $data['total_bobot'] ?? 0 ?></h2>
                          <p class="card-modern-text">Skala 1-100</p>
                        </div>
                        <div class="card-modern-chart">
                          <div class="progress-chart">
                            <svg viewBox="0 0 100 100">
                ...
                <!-- Modern Search -->
                <div class="card-modern-search mb-4" data-aos="fade-up" data-aos-delay="500">
                  <div class="card-modern-search-body">
                    <form method="GET" action="index.php?controller=kriteria&action=index">
                        ...
                        <div class="col-md-11">
                          <div class="search-input-wrapper">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Cari berdasarkan kode, nama kriteria, atau pertanyaan..."
                                   value="<?= htmlspecialchars($data['keyword'] ?? '') ?>">
                            <?php if (!empty($data['keyword'])): ?>
                              <a href="index.php?controller=kriteria&action=index" class="search-clear">
                ...
                <!-- Modern Table -->
                <div class="card-modern-table" data-aos="fade-up" data-aos-delay="600">
                        ...
                        <tbody>
                          <?php if (!empty($data['kriterias'])): ?>
                            ...
                            <tr class="table-row-modern" data-aos="fade-in" data-aos-delay="<?= $no * 50 ?>">
                              ...
                              <td>
                                <div class="kriteria-pertanyaan">
                                  <?= htmlspecialchars(substr($kriteria['pertanyaan'], 0, 80)) ?>
                                  <?= strlen($kriteria['pertanyaan']) > 80 ? '...' : '' ?>
                                </div>
                              </td>
                              <td>
                                <div class="botlinjau-wrapper">
                                  <div class="botlinjau-bar">
                                    <div class="botlinjau-fill" style="width: <?= $kriteria['bobot'] ?>%"></div>
                                  </div>
                                  <span class="botlinjau-text"><?= $kriteria['bobot'] ?>%</span>
                                </div>
                              </td>
                              <td>
                                <span class="badge-modern badge-modern-<?= $kriteria['jenis'] == 'benefit' ? 'success' : 'info' ?>">
                                  <?= ucfirst($kriteria['jenis']) ?>
                                </span>
                              </td>
                              <td>
                                <div class="action-buttons-modern">
                                  <a href="index.php?controller=kriteria&action=edit&id=<?= $kriteria['id_kriteria'] ?>"
                                     class="btn-modern-action btn-modern-edit"
                                     title="Edit">
                                    <i class="fas fa-edit"></i>
                                  </a>
                                  <button onclick="confirmDelete(<?= $kriteria['id_kriteria'] ?>)"
                            ...
                            <tr class="empty-state-modern">
                              <td colspan="7" class="text-center">
                                <div class="empty-state-content">
                                  ...
                                  <h4 class="empty-state-title">Belum ada data kriteria</h4>
                                  <p class="empty-state-text">Mulai dengan menambahkan kriteria penilaian baru</p>
                                  <a href="index.php?controller=kriteria&action=create"
  ...
  <style>
    ...
    .alert-modern-success {
      ...
      border-radius: 12px;
      padding: 1rem 1.5rem;
      box-shadow: 0 4px 16px rgba(49, 151, 93, 0.15);
      margin-bottom: 1.5rem;
    }
    ...
    .alert-modern-danger .alert-message strong {
      color: #c53030;
    }

    .alert-modern-success .alert-message strong {
      color: #2f855a;
    }
  ...
  <script>
    ...
    function confirmDelete(id) {
      if (confirm('Apakah Anda yakin ingin menghapus kriteria ini?')) {
        window.location.href = 'index.php?controller=kriteria&action=delete&id=' + id;
      }
    }
