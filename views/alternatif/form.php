...
<body class="with-welcome-text">
              ...
              <div class="home-header mb-4" data-aos="fade-down">
                    ...
                    <div class="d-flex align-items-center mb-2">
                      ...
                      <div>
                        <h3 class="font-weight-bold mb-0">
                          <?= $data['form_type'] == 'create' ? 'Tambah Layanan Baru' : 'Edit Layanan' ?>
                        </h3>
                        <p class="text-muted mb-0">
                          <?= $data['form_type'] == 'create' ? 'Isi form untuk menambahkan layanan baru' : 'Perbarui data layanan' ?>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-modern-form" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="form-header-content">
                      ...
                      <div class="form-header-text">
                        <h4 class="form-header-title">
                          <?= $data['form_type'] == 'create' ? 'Form Tambah Layanan' : 'Form Edit Layanan' ?>
                        </h4>
                  ...
                  <div class="card-modern-form-body">
                    <form method="POST" action="<?= $data['form_action'] ?>" id="alternatifForm" class="form-modern">
                      ...
                      <div class="form-group-modern">
                        <label for="kode_alternatif" class="form-label-modern">
                          <i class="fas fa-hashtag label-icon"></i>
                          Kode Layanan <span class="required">*</span>
                        </label>
                      ...
                      <!-- Nama Layanan -->
                      <div class="form-group-modern">
                        <label for="nama_layanan" class="form-label-modern">
                        ...
                        <small class="form-text-modern">
                          <i class="fas fa-info-circle"></i>
                          Nama layanan yang akan ditampilkan dalam sistem
                        </small>
                      </div>
                      ...
                      <div class="form-group-modern">
                        ...
                        <div class="textarea-group-modern">
                          <textarea class="form-control-modern form-control-textarea-modern"
                                    ...
                                    maxlength="1000"><?= $data['form_type'] == 'edit' ? htmlspecialchars($data['alternatif']['keterangan']) : '' ?></textarea>
                          <div class="textarea-counter">
                            <span id="keterangan-counter">0</span>/1000
                          </div>
                        </div>
                        <small class="form-text-modern">
                          <i class="fas fa-info-circle"></i>
                      ...
                      <div class="form-actions-modern">
                        ...
                        <a href="index.php?controller=alternatif&action=index" class="btn btn-modern-secondary btn-lg">
                    ...
                    <div class="info-list">
                      <div class="info-item">
                        ...
                        <div class="info-item-content">
                          ...
                          <p>Layanan akan digunakan dalam perhitungan metode SMART</p>
                        </div>
                      </div>
                      <div class="info-item">
                        <div class="info-item-icon">
                        ...
                        <div class="info-item-content">
                          ...
                          <p>Kode layanan harus unik dan tidak boleh duplikat</p>
                        </div>
                      </div>
                      <div class="info-item">
                        <div class="info-item-icon">
                        ...
                        <div class="info-item-content">
                          ...
                          <p>Gunakan format huruf kapital dan angka (contoh: A01, B02)</p>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <script>
    ...
    document.getElementById('alternatifForm').addEventListener('submit', function(e) {
      ...
      // Reset error states
      kode.style.borderColor = '#e2e8f0';
      nama.style.borderColor = '#e2e8f0';
      ...
      if (!kode.value.trim()) {
        ...
        kode.focus();
        showAlert('Kode layanan wajib diisi!', 'error');
        isValid = false;
      } else if (!/^[A-Z0-9]+$/.test(kode.value)) {
        e.preventDefault();
        kode.style.borderColor = '#e53e3e';
        kode.focus();
        showAlert('Kode layanan hanya boleh huruf kapital dan angka!', 'error');
        isValid = false;
      } else if (kode.value.length > 10) {
        e.preventDefault();
        kode.style.borderColor = '#e53e3e';
        kode.focus();
        showAlert('Kode layanan maksimal 10 karakter!', 'error');
        isValid = false;
      }
      ...
      if (!nama.value.trim()) {
        ...
        nama.focus();
        showAlert('Nama layanan wajib diisi!', 'error');
        isValid = false;
      }
    ...
    document.getElementById('alternatifForm').addEventListener('submit', function() {
